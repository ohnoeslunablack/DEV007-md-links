...
const printGettingStarted = ()=> {
    ...
    log(colorizeText('1. Ingresa el comando "node cli" seguido de la ruta al archivo o directorio que deseas (puede ser una ruta relativa como: directorio/ejemplo.md). Aparecerá una lista con cada enlace encontrado.\n', 'blue'));
    ...
    log(colorizeText('5. Si tienes alguna pregunta y necesitas conocer los comandos nuevamente, escribe "node cli --help".', 'blue'));
};
